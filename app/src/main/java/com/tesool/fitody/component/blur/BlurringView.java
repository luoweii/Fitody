package com.tesool.fitody.component.blur;
...
public class BlurringView extends View {
    ...
    public BlurringView(Context context, AttributeSet attrs) {
        ...
        setBlurRadius(a.getDimensionPixelSize(R.styleable.PxBlurringView_blurRadius, defaultBlurRadius));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBlurredView != null) {
            if (prepare()) {
                ...
                canvas.save();
//                canvas.translate(mBlurredView.getX() - getX(), getHeight() - mBlurredView.getHeight());
    ...
    protected boolean prepare() {
        ...
        if (mBlurringCanvas == null || mDownsampleFactorChanged
            ...
            mBlurringCanvas.translate(0, getHeight() - mBlurredView.getHeight());
